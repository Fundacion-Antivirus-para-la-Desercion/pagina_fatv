...
import { JAVI_SENALA_IMG as JaviSonrie } from "../../../assets/cloudinaryImages";
...
function OrganizationalStructure() {
  ...
  const isPuzzleOneInView = useInView(puzzleOneRef, {
    once: true,
    amount: 0.5,
  });
  const isPuzzleTwoInView = useInView(puzzleTwoRef, {
    once: true,
    amount: 0.5,
  });
  const isPuzzleThreeInView = useInView(puzzleThreeRef, {
    once: true,
    amount: 0.5,
  });
  const isPuzzleFourInView = useInView(puzzleFourRef, {
    once: true,
    amount: 0.5,
  });
